...
# -*- coding: utf-8 -*-
"""
Created on Sat Jul 24 05:27:06 2021
...
class Node:
    ...
    def __cmp__(self,otherVertex):# this cmp will define according to what we will select 
    #  the minimum node for heap : here on the basis of min distance but can be anything 
    #  like visited or neighbours
